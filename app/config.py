...
API_LIMIT = int(os.getenv("API_LIMIT", 15_000))  # max rows to pull per refresh (lower for low-RAM tiers)
API_YEARS_BACK = int(os.getenv("API_YEARS_BACK", 2))  # limit by recent years for speed
